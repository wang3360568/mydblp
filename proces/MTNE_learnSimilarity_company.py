...
if __name__ == "__main__":
    ...
    pickle.dump(a_list, open('A_list_company_'+label+'.dat', "wb"), True)
    pickle.dump(f_list, open('F_list_company_'+label+'.dat', "wb"), True)
    pickle.dump(s, open('S_company_'+label+'.dat', "wb"), True)